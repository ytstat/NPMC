...
R CMD BATCH --no-save --vanilla logistic_model1_check.R /out/${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.txt # run "logistic_model1_check.R" and save the output information
