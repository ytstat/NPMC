...
R CMD BATCH --no-save --vanilla knn_model1_check.R /burg/home/yt2661/projects/NPMC/experiment/simulation/knn_model1_check/out/${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.txt
