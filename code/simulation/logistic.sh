#!/bin/sh
#
# run "logistic.R" using the script
#
#SBATCH --account=stats         # Replace ACCOUNT with your group account name
#SBATCH --job-name=logistic     # The job name.
...
R CMD BATCH --no-save --vanilla logistic.R /out/${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.txt  # run "logistic.R" and save the output information
