...
R CMD BATCH --no-save --vanilla loanclub_logistic.R /burg/home/yt2661/projects/NPMC/experiment/real_data/loanclub_logistic/out/${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.txt
