#!/bin/sh
#
# run "loanclub.R" using the script
#
...
R CMD BATCH --no-save --vanilla loanclub.R /out/${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.txt # run "loanclub.R" and save the output information
